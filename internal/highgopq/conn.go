// Package highgo 是 github.com/melf-xyzh/highgo-lib@8ddafe0 的本地 fork（MIT 协议，见同目录 LICENSE.md）。
// 唯一改动：init() 里的驱动注册名从 "postgres" 改为 "highgo"，避免和已引入的 github.com/lib/pq 冲突
// （两者若都注册为 "postgres" 会在 sql.Register 阶段直接 panic）。
package highgo
